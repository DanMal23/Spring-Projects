...
.tab2p {position:absolute;left:265px; }
.tab3p {position:absolute;left:620px; }
.tab4p {position:absolute;left:780px; }
...
.tab4 {position:absolute;left:780px; }
...
<form:form action="svar" modelAttribute="verb" autocomplete="off">
...
gråte  <span class="tab3"><form:input path="gråt" size="12"/> <form:errors path="gråt" cssClass="error"/></span>
       <span class="tab4"><form:input path="grått" size="12"/> <form:errors path="grått" cssClass="error"/></span><br>
...
lyve   <span class="tab3"><form:input path="løy" size="12"/> <form:errors path="løy" cssClass="error"/></span>
       <span class="tab4"><form:input path="løyet" size="12"/> <form:errors path="løyet" cssClass="error"/></span>
