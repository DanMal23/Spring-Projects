...
public class Verb1 {
    ...
    public String getSkalv() { return skalv; }

    public void setSkalv(String skalv) { this.skalv = skalv; }

    public String getSkjelvet() { return skjelvet; }

    public void setSkjelvet(String skjelvet) { this.skjelvet = skjelvet;}
